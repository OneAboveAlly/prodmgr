...
console.log('🧠 ZALOGOWANY UŻYTKOWNIK:', user);
  ...
  const {
    ...
    enabled: isReady // poczekaj aż auth się załaduje
  });
  ...
  const handleAddRole = () => navigate('/roles/new');
  const handleEditRole = (roleId) => navigate(`/roles/edit/${roleId}`);
  const handleViewRole = (roleId) => navigate(`/roles/${roleId}`);
